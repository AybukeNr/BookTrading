...
<head>
    ...
    <title>BookSwap Hesabınız Başarıyla Oluşturuldu</title>
</head>
...
<table style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 5px;">
    ...
    <tr>
        <td style="text-align: center;">
            <p style="color: #000;">Kullanıcı Adı: </p>
            <p style="color: #000;">Şifre: </p>
        </td>
    </tr>
    <tr>
        <td style="text-align: center;">
            <p style="color: #666666;">E-posta adresinizi doğrulamak için aşağıdaki butona tıklayın:</p>
            <a href="" style="display: inline-block; padding: 10px 20px; background-color: #28a745; color: #ffffff; text-decoration: none; border-radius: 5px;">Burada bir buton olduğunu hayal edin</a>
