...
<table style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 5px;">
    ...
    <tr>
        <td style="padding: 20px 0px; text-align: center;">
            <p style="color: #666666;">BookSwap hesabınız için yeni bir şifre talep edildi.</p>
            <p style="color: #666666;">Bu talebi siz yapmadıysanız, bu e-postayı dikkate almayın.</p>
            <p style="color: #666666;">E-posta adresinizi doğrulamak için aşağıdaki butona tıklayın:</p>
            <a href="${link}" style="display: inline-block; padding: 10px 20px; background-color: #28a745; color: #ffffff; text-decoration: none; border-radius: 5px;">Şifreyi Sıfırla</a>
        </td>
    </tr>
    <tr>
